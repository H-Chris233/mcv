...
public object FfiConverterTypeMcvFfiError : FfiConverterRustBuffer<McvFfiException> {
    override fun read(buf: ByteBuffer): McvFfiException {
        ...
        return when(buf.getInt()) {
            ...
            8 -> McvFfiException.InvalidCardPayload()
            9 -> McvFfiException.InvalidVaultBlob()
            10 -> McvFfiException.InvalidVaultPlaintext()
            11 -> McvFfiException.CardAuthenticationFailed()
            12 -> McvFfiException.VaultAuthenticationFailed()
            13 -> McvFfiException.CryptoException()
            14 -> McvFfiException.ShamirException()
